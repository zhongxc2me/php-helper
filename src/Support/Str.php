...
class Str
{
     ...
     **@since  1.0
     */
    public static function randStr($len = 8, bool $number = true, bool $letter = false, bool $capitals = false, bool $symbols = false): string
    {
     ...
     **@since  1.0
     */
    public static function subStrTo(string $haystack, string $needle): string
    {
     ...
     * @return string
     */
    public static function subStr($haystack, $needleStart, string $needleEnd = ""): string
    {
     ...
     **@since  1.0
     */
    public static function strLimit(string $value, int $limit = 100, string $end = '...'): string
    {
     ...
     **/
    public static function replaceStringVariable(string $string, array $varArr): string
    {
        $search = [];
        $replace = [];
     ...
     */
    public static function str2num(string $string)
    {
        $d = array(
     ...
     * @param string|null $database 库名
     * @return string
     * @author litong
     */
    public static function array2sql(array $array, string $table, string $database = null): string
    {
     ...
     * @author litong
     */
    public static function array2DuplicateKeySql(array $fields, array $excludeFields): string
    {
     ...
     * @author litong
     */
    public static function getIdsByStr($string): array
    {
     ...
     * @author litong
     */
    public static function hasMessyCodes($string): bool
    {
     ...
     * @author litong
     */
    public static function toCsvString(array $array): string
    {
